...
Fraction operator+(Fraction & frac, int term)
{
	int temp = term * frac.denominator;

	if (!term) return frac;

	if (!(frac.numerator + temp)) return Fraction(0, 0);

	return Fraction(frac.numerator + temp, frac.denominator);
}

Fraction operator+(int term, Fraction & frac)
{
	int temp = term * frac.denominator;
...
Fraction operator-(Fraction & firstFrac, Fraction & secondFrac)
{
...
Fraction operator-(int term, Fraction & frac)
{
	...
	if (!(temp - frac.numerator)) return Fraction(0, 0);

	return Fraction(temp - frac.numerator, frac.denominator);
}
...
Fraction operator*(Fraction & frac, int mul)
{
	if (!mul) return Fraction(0, 0);

	return Fraction(frac.numerator * mul, frac.denominator);
}

Fraction operator*(int mul, Fraction & frac)
{
	if (!mul) return Fraction(0, 0);
...
Fraction operator/(Fraction & frac, int div)
{
	if (div == 0) return Fraction(99999999, 1);
	return Fraction(frac.numerator, frac.denominator * div);
}

Fraction operator/(int div, Fraction & frac)
{
	if (div == 0) return Fraction(0, 0);

	return Fraction(frac.numerator * div, frac.denominator);
}*/
